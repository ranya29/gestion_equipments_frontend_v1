...
export default function UserInfoCard() {
  ...
  return (
    <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
      ...
      <Modal isOpen={isOpen} onClose={handleModalClose} className="max-w-[600px] m-4">
        <div className="no-scrollbar relative w-full overflow-y-auto rounded-3xl bg-white p-4 dark:bg-gray-900 lg:p-11">
          ...
          {success && (
            <div className="mx-2 mb-4 p-3 bg-green-50 border border-green-200 rounded-lg dark:bg-green-900/20 dark:border-green-800">
              <p className="text-sm text-green-600 dark:text-green-400">Profil mis à jour avec succès!</p>
            </div>
          )}
