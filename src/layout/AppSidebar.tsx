...
// ✅ SECTION PRINCIPALE - Modifiée pour votre projet
const navItems: NavItem[] = [
  ...
  {
    icon: <BoxCubeIcon />, // Icône pour équipements
    name: "Équipements",
    subItems: [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Mes réservations", path: "/reservations", pro: false, new: true },
      { name: "Nouvelle réservation", path: "/reservations/new", pro: false },
    ],
  },
  {
    icon: <TableIcon />,
...
// ✅ SECTION OTHERS - Conservée pour les éléments techniques
